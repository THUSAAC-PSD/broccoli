...
pub fn init() -> FnResult<String> {
    let host = Host::new();
    host.registry
        .register_checker_format("exact", "check_exact")?;
    host.registry
        .register_checker_format("lines", "check_lines")?;
    host.registry
        .register_checker_format("tokens", "check_tokens")?;
    host.registry
        .register_checker_format("tokens-case-insensitive", "check_tokens_ci")?;
    host.registry
        .register_checker_format("tokens-float", "check_tokens_float")?;
    host.registry
        .register_checker_format("unordered-tokens", "check_unordered_tokens")?;
    host.registry
        .register_checker_format("unordered-lines", "check_unordered_lines")?;
    host.registry
        .register_checker_format("testlib", "check_testlib")?;
    host.registry
        .register_checker_format("none", "check_none")?;
